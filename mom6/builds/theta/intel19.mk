...
NETCDF_DIR = /opt/cray/pe/netcdf/4.4.1.1.3/INTEL/16.0
NETCDF_ROOT = $(NETCDF_DIR)
HDF5_DIR = /opt/cray/pe/hdf5/1.10.0/INTEL/15.0/
HDF5_ROOT = $(HDF5_DIR)
...
FFLAGS_REPRO = -O2 -debug minimal -fp-model source -qoverride-limits -g -traceback -dynamic
