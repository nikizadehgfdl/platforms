  ##Steps below are needed before running this script
  ...
  #
  export installDir='/contrib/Niki.Zadeh/opt/nvhpc239P3gpu'
  #Build hdf5
  export CC='/contrib/Niki.Zadeh/spack/var/spack/environments/nvhpc239P3gpu/.spack-env/view/Linux_x86_64/23.9/comm_libs/mpi/bin/mpicc'
  export FC='/contrib/Niki.Zadeh/spack/var/spack/environments/nvhpc239P3gpu/.spack-env/view/Linux_x86_64/23.9/comm_libs/mpi/bin/mpif90'
  export LD_LIBRARY_PATH=/contrib/Niki.Zadeh/spack/var/spack/environments/nvhpc239P3gpu/.spack-env/view/Linux_x86_64/23.9/comm_libs/openmpi/openmpi-3.1.5/lib:${LD_LIBRARY_PATH}
