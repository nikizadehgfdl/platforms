...
FPPFLAGS += -I/opt/pgi/19.10/linux86-64/19.10/mpi/openmpi-3.1.3/include
...
CPPFLAGS = $(INCLUDES)
CPPFLAGS += -I/opt/pgi/19.10/linux86-64/19.10/mpi/openmpi-3.1.3/include
# C Compiler flags for the NetCDF library
CPPFLAGS += -I/opt/netcdf/4.6.1/PGI/include
...
LIBS := -L/opt/pgi/19.10/linux86-64/2019/mpi/openmpi-3.1.3/lib/ 
LIBS += -L/opt/netcdf/4.6.1/PGI/lib64/ 
